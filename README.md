...
```toml
[templates.obsidian]
input_path = '~/.config/matugen/templates/obsidian/colors.css'
output_path = '/PATH/TO/YOUR/OBSIDIAN/VAULT/.obsidian/snippets/matugen.css'
```
4. Generate matugen colors
5. Go back to obsidian and go to `Settings > Appearance > CSS snippets` and enable the one called matugen
...
## Zen
Credit: jiboli [Repo](https://github.com/jiboli/matugen-zen-template/)
